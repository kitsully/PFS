...
# creates a dictionary of the data in an inode
def createDict(data):
    b = data.split(',')
    dic = {}
    for item in b:
...
# ensures the user is specifying a valid filename
...
# looks up a file in the specified directory and returns its inode number
...
# creates a file of regulary type
...
# creates a file of type directory
